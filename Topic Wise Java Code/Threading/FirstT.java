/* Write a program in java to implement a Multithread using the
Thread class, create the three classes extending the Thread class
and start the these simultaneously.*/
